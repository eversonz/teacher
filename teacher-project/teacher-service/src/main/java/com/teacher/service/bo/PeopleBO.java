...
public class PeopleBO {
	...
	public List<PeopleVO> selectByMonitor(Long roleId, Long matterId, String state, String search, Long countryId) {
		return usuarioMapper.selectByMonitor(roleId, matterId, state, search, countryId);
	}	
}
